document.addEventListener('DOMContentLoaded', function() {
    ...
    // GÜNCELLENMİŞ VERİ YAPISI (Maddeler çıkarıldı)
    const kriterler = [
        {
            kategori_id: 1,
            kategori_adi: "ARAÇLAR / TEKNOLOJİ", // 9 Puan
            maddeler: [
        ...
        {
            kategori_id: 2,
            kategori_adi: "ÖĞRENME ETKİNLİĞİ", // 6 Puan
            maddeler: [
        ...
        {
            kategori_id: 3,
            kategori_adi: "BAĞLANTILAR / İÇERİKLER", // 1 Puan
            maddeler: [
    ...
    function renderKriterler() {
        ...
        kriterler.forEach(kategori => {
            ...
            kategori.maddeler.forEach(madde => {
                // Madde numaralarını yeniden düzenliyoruz.
                const mevcutId = `${kategori.kategori_id}.${maddeNo++}`;
                kategoriHtml += `
                    <label class="kriter">
            ...
            maddeNo = 1; // Her kategori için numaralandırmayı sıfırla
            kategoriHtml += '</div>';
    ...
    // GÜNCELLENMİŞ PUAN ARALIKLARI (16 puanlık sisteme göre ayarlandı)
